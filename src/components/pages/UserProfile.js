      ...
      <div className="container">
        <div className="row userinfo">
          ...
          <div className="col-lg-9 tab-content" id="v-pills-tabContent">
            <div class="tab-pane fade show active profile_area pdd_8" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
              <Profile />
            </div>
            <div class="tab-pane fade profile_area pdd_8" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
              <h1 class="profile_h1 mb-3">Your Offers</h1>
              <GeneralOffer offers={offers}/>
            </div>
          </div>
        </div>
      </div>
